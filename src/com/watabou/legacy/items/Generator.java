...
import com.watabou.legacy.actors.mobs.npcs.Wandmaker.Rotberry;
import com.watabou.legacy.items.armor.*;
import com.watabou.legacy.items.bags.Bag;
import com.watabou.legacy.items.food.Food;
import com.watabou.legacy.items.food.MysteryMeat;
import com.watabou.legacy.items.food.Pasty;
import com.watabou.legacy.items.potions.*;
import com.watabou.legacy.items.rings.*;
import com.watabou.legacy.items.scrolls.*;
import com.watabou.legacy.items.wands.*;
import com.watabou.legacy.items.weapon.*;
import com.watabou.legacy.items.weapon.melee.*;
import com.watabou.legacy.items.weapon.missiles.*;
import com.watabou.legacy.plants.*;
